...
pub struct RestSearchAttributes200Response {
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::RestSearchAttributes200ResponseResponse>>,
}

impl RestSearchAttributes200Response {
    pub fn new() -> RestSearchAttributes200Response {
        RestSearchAttributes200Response {
            response: None,
        }
    }
}
