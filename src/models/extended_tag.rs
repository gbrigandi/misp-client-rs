...
pub struct ExtendedTag {
    ...
    #[serde(rename = "Taxonomy", skip_serializing_if = "Option::is_none")]
    pub taxonomy: Option<Box<models::Taxonomy>>,
    #[serde(rename = "TaxonomyPredicate", skip_serializing_if = "Option::is_none")]
    pub taxonomy_predicate: Option<Box<models::TaxonomyPredicate>>,
    #[serde(rename = "GalaxyCluster", skip_serializing_if = "Option::is_none")]
    pub galaxy_cluster: Option<Box<models::GalaxyCluster>>,
}

impl ExtendedTag {
    pub fn new() -> ExtendedTag {
        ExtendedTag {
            tag: None,
            taxonomy: None,
            taxonomy_predicate: None,
            galaxy_cluster: None,
        }
    }
}
