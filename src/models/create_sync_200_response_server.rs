...
pub struct CreateSync200ResponseServer {
    ...
    pub organisation: Option<Box<models::CreateSync200ResponseServerOrganisation>>,
}

impl CreateSync200ResponseServer {
    pub fn new() -> CreateSync200ResponseServer {
        CreateSync200ResponseServer {
            url: None,
            uuid: None,
            authkey: None,
            organisation: None,
