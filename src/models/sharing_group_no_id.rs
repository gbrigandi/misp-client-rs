...
pub struct SharingGroupNoId {
    ...
    #[serde(rename = "releasability", skip_serializing_if = "Option::is_none")]
    pub releasability: Option<String>,
    #[serde(rename = "local", skip_serializing_if = "Option::is_none")]
    pub local: Option<bool>,
    #[serde(rename = "active", skip_serializing_if = "Option::is_none")]
    pub active: Option<bool>,
    #[serde(rename = "org_count", skip_serializing_if = "Option::is_none")]
    pub org_count: Option<String>,
    #[serde(rename = "organisation_uuid", skip_serializing_if = "Option::is_none")]
    pub organisation_uuid: Option<uuid::Uuid>,
    #[serde(rename = "org_id", skip_serializing_if = "Option::is_none")]
    pub org_id: Option<String>,
    #[serde(rename = "sync_user_id", skip_serializing_if = "Option::is_none")]
    pub sync_user_id: Option<String>,
    #[serde(rename = "created", skip_serializing_if = "Option::is_none")]
    pub created: Option<String>,
    #[serde(rename = "modified", skip_serializing_if = "Option::is_none")]
    pub modified: Option<String>,
    #[serde(rename = "roaming", skip_serializing_if = "Option::is_none")]
    pub roaming: Option<bool>,
}

impl SharingGroupNoId {
    pub fn new() -> SharingGroupNoId {
        SharingGroupNoId {
            uuid: None,
            name: None,
            description: None,
