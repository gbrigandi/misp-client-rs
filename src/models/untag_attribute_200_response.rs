...
pub struct UntagAttribute200Response {
    /// `true` if the tag was succesfully removed, `false` if it failed
    #[serde(rename = "saved", skip_serializing_if = "Option::is_none")]
    pub saved: Option<bool>,
    /// Present if the tag was succesfully added
    ...
    #[serde(rename = "check_publish", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub check_publish: Option<Option<bool>>,
...
impl UntagAttribute200Response {
    pub fn new() -> UntagAttribute200Response {
        UntagAttribute200Response {
            saved: None,
            success: None,
            check_publish: None,
            errors: None,
