...
pub struct GetNoticelists200ResponseInner {
    #[serde(rename = "Noticelist", skip_serializing_if = "Option::is_none")]
    pub noticelist: Option<Box<models::Noticelist>>,
}

impl GetNoticelists200ResponseInner {
    pub fn new() -> GetNoticelists200ResponseInner {
