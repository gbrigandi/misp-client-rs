...
pub struct RestSearchEvents200Response {
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Vec<models::EventRestSearchListInner>>,
}

impl RestSearchEvents200Response {
    pub fn new() -> RestSearchEvents200Response {
