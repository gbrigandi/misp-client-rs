...
pub struct MinimalAnalystData {
    #[serde(rename = "Note", skip_serializing_if = "Option::is_none")]
    pub note: Option<std::collections::HashMap<String, String>>,
    #[serde(rename = "Opinion", skip_serializing_if = "Option::is_none")]
    pub opinion: Option<std::collections::HashMap<String, String>>,
    #[serde(rename = "Relationship", skip_serializing_if = "Option::is_none")]
    pub relationship: Option<std::collections::HashMap<String, String>>,
}

impl MinimalAnalystData {
    /// Minimal Analyst Data (notes, opinions and relationships).
    pub fn new() -> MinimalAnalystData {
        MinimalAnalystData {
            note: None,
            opinion: None,
            relationship: None,
