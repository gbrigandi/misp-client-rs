...
pub struct ViewEventReport200Response {
    #[serde(rename = "EventReport", skip_serializing_if = "Option::is_none")]
    pub event_report: Option<Box<models::EventReport>>,
}

impl ViewEventReport200Response {
    pub fn new() -> ViewEventReport200Response {
        ViewEventReport200Response {
            event_report: None,
        }
    }
}
