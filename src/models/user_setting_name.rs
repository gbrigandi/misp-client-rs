...
pub enum UserSettingName {
    ...
    DefaultRestsearchParameters,
    #[serde(rename = "tag_numerical_value_override")]
    TagNumericalValueOverride,
    #[serde(rename = "event_index_hide_columns")]
    EventIndexHideColumns,

}

impl std::fmt::Display for UserSettingName {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::PublishAlertFilter => write!(f, "publish_alert_filter"),
            Self::DashboardAccess => write!(f, "dashboard_access"),
            Self::Dashboard => write!(f, "dashboard"),
            Self::Homepage => write!(f, "homepage"),
            Self::DefaultRestsearchParameters => write!(f, "default_restsearch_parameters"),
            Self::TagNumericalValueOverride => write!(f, "tag_numerical_value_override"),
            Self::EventIndexHideColumns => write!(f, "event_index_hide_columns"),
        }
    }
}

impl Default for UserSettingName {
    fn default() -> UserSettingName {
        Self::PublishAlertFilter
    }
}
