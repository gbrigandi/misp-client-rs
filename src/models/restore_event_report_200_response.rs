...
pub struct RestoreEventReport200Response {
    /// `true` if the event was succesfully deleted, `false` if it failed
...
impl RestoreEventReport200Response {
    pub fn new() -> RestoreEventReport200Response {
