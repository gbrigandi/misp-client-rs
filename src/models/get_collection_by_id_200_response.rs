...
pub struct GetCollectionById200Response {
    #[serde(rename = "Collection", skip_serializing_if = "Option::is_none")]
    pub collection: Option<Box<models::CollectionFull>>,
}

impl GetCollectionById200Response {
    pub fn new() -> GetCollectionById200Response {
