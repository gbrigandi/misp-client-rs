...
pub struct ExportTaxonomy200Response {
    ...
    pub predicates: Option<Vec<models::TaxonomyPredicateExport>>,
    #[serde(rename = "values", skip_serializing_if = "Option::is_none")]
    pub values: Option<Vec<models::TaxonomyValueExport>>,
}

impl ExportTaxonomy200Response {
    pub fn new() -> ExportTaxonomy200Response {
        ExportTaxonomy200Response {
            namespace: None,
            description: None,
            version: None,
            exclusive: None,
