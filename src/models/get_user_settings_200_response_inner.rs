...
pub struct GetUserSettings200ResponseInner {
    #[serde(rename = "UserSetting", skip_serializing_if = "Option::is_none")]
    pub user_setting: Option<Box<models::UserSetting>>,
}

impl GetUserSettings200ResponseInner {
    pub fn new() -> GetUserSettings200ResponseInner {
