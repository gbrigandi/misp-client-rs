...
pub struct RestSearchObjects200Response {
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Vec<models::ObjectRestSearchList>>,
}

impl RestSearchObjects200Response {
    pub fn new() -> RestSearchObjects200Response {
