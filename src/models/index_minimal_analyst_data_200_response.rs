...
#[serde(untagged)]
pub enum IndexMinimalAnalystData200Response {
    MinimalAnalystData(Box<models::MinimalAnalystData>),
    /// Minimal Analyst Data
    MinimalAnalystDataEmpty(Vec<serde_json::Value>),
}

impl Default for IndexMinimalAnalystData200Response {
    fn default() -> Self {
        Self::MinimalAnalystData(Default::default())
    }
}
