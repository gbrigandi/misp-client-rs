...
/// LastRestSearchFilter : Events published within the last x amount of time, where x can be defined in days, hours, minutes (for example 5d or 12h or 30m), ISO 8601 datetime format or timestamp
...
#[serde(untagged)]
pub enum LastRestSearchFilter {
    Integer(i32),
    String(String),
}

impl Default for LastRestSearchFilter {
    fn default() -> Self {
