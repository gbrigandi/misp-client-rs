...
pub struct AttachGalaxyClusterRequestGalaxy {
    /// Target galaxy cluster to attach.
    #[serde(rename = "target_id", skip_serializing_if = "Option::is_none")]
    pub target_id: Option<i32>,
}

impl AttachGalaxyClusterRequestGalaxy {
    pub fn new() -> AttachGalaxyClusterRequestGalaxy {
        AttachGalaxyClusterRequestGalaxy {
            target_id: None,
        }
    }
}
