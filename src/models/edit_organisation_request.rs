...
pub struct EditOrganisationRequest {
    ...
    #[serde(rename = "sector", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "local", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub local: Option<Option<bool>>,
    ...
    #[serde(rename = "restricted_to_domain", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub restricted_to_domain: Option<Option<Vec<String>>>,
}

impl EditOrganisationRequest {
    pub fn new() -> EditOrganisationRequest {
