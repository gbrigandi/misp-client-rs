...
pub struct NoticelistEntry {
    ...
    #[serde(rename = "noticelist_id", skip_serializing_if = "Option::is_none")]
    pub noticelist_id: Option<String>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::NoticelistEntryData>>,
}

impl NoticelistEntry {
    pub fn new() -> NoticelistEntry {
        NoticelistEntry {
            id: None,
            noticelist_id: None,
            data: None,
