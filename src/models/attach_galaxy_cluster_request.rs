...
pub struct AttachGalaxyClusterRequest {
    #[serde(rename = "Galaxy", skip_serializing_if = "Option::is_none")]
    pub galaxy: Option<Box<models::AttachGalaxyClusterRequestGalaxy>>,
}

impl AttachGalaxyClusterRequest {
    pub fn new() -> AttachGalaxyClusterRequest {
