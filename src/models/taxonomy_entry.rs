...
pub struct TaxonomyEntry {
    ...
    #[serde(rename = "exclusive_predicate", skip_serializing_if = "Option::is_none")]
    pub exclusive_predicate: Option<bool>,
    #[serde(rename = "existing_tag", skip_serializing_if = "Option::is_none")]
