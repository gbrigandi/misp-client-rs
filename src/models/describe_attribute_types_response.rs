...
pub struct DescribeAttributeTypesResponse {
    #[serde(rename = "sane_defaults", skip_serializing_if = "Option::is_none")]
    pub sane_defaults: Option<serde_json::Value>,
    #[serde(rename = "types", skip_serializing_if = "Option::is_none")]
    pub types: Option<Vec<models::AttributeType>>,
    #[serde(rename = "categories", skip_serializing_if = "Option::is_none")]
    pub categories: Option<Vec<models::AttributeCategory>>,
    #[serde(rename = "category_type_mappings", skip_serializing_if = "Option::is_none")]
    pub category_type_mappings: Option<serde_json::Value>,
}

impl DescribeAttributeTypesResponse {
    /// Lists available attribute types, default categories and category-type mappings.
    pub fn new() -> DescribeAttributeTypesResponse {
