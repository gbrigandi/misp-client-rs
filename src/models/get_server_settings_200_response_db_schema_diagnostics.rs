...
pub struct GetServerSettings200ResponseDbSchemaDiagnostics {
    #[serde(rename = "dataSource", skip_serializing_if = "Option::is_none")]
    pub data_source: Option<String>,
    #[serde(rename = "actual_db_version", skip_serializing_if = "Option::is_none")]
    pub actual_db_version: Option<String>,
    #[serde(rename = "checked_table_column", skip_serializing_if = "Option::is_none")]
    pub checked_table_column: Option<Vec<String>>,
    #[serde(rename = "diagnostic", skip_serializing_if = "Option::is_none")]
    pub diagnostic: Option<serde_json::Value>,
    #[serde(rename = "diagnostic_index", skip_serializing_if = "Option::is_none")]
    pub diagnostic_index: Option<Box<models::GetServerSettings200ResponseDbSchemaDiagnosticsDiagnosticIndex>>,
    #[serde(rename = "expected_db_version", skip_serializing_if = "Option::is_none")]
    pub expected_db_version: Option<String>,
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
    #[serde(rename = "update_locked", skip_serializing_if = "Option::is_none")]
    pub update_locked: Option<bool>,
    #[serde(rename = "remaining_lock_time", skip_serializing_if = "Option::is_none")]
    pub remaining_lock_time: Option<f64>,
    #[serde(rename = "update_fail_number_reached", skip_serializing_if = "Option::is_none")]
    pub update_fail_number_reached: Option<bool>,
    #[serde(rename = "indexes", skip_serializing_if = "Option::is_none")]
    pub indexes: Option<serde_json::Value>,
    #[serde(rename = "columnPerTable", skip_serializing_if = "Option::is_none")]
    pub column_per_table: Option<serde_json::Value>,
}

impl GetServerSettings200ResponseDbSchemaDiagnostics {
    pub fn new() -> GetServerSettings200ResponseDbSchemaDiagnostics {
        GetServerSettings200ResponseDbSchemaDiagnostics {
            data_source: None,
            actual_db_version: None,
            checked_table_column: None,
            diagnostic: None,
            ...
            update_fail_number_reached: None,
            indexes: None,
            column_per_table: None,
        }
    }
}
