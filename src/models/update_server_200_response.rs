...
pub struct UpdateServer200Response {
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<models::UpdateServer200ResponseResultsInner>>,
}

impl UpdateServer200Response {
    pub fn new() -> UpdateServer200Response {
