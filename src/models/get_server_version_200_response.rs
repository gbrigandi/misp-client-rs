...
pub struct GetServerVersion200Response {
    ...
    #[serde(rename = "perm_sync", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub perm_sync: Option<Option<bool>>,
    #[serde(rename = "perm_sighting", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub perm_sighting: Option<Option<bool>>,
    #[serde(rename = "perm_galaxy_editor", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub perm_galaxy_editor: Option<Option<bool>>,
    #[serde(rename = "request_encoding", skip_serializing_if = "Option::is_none")]
    pub request_encoding: Option<Vec<RequestEncoding>>,
}

impl GetServerVersion200Response {
    pub fn new() -> GetServerVersion200Response {
