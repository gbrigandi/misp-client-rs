...
pub struct AnalystRelationship {
    ...
    #[serde(rename = "object_uuid", skip_serializing_if = "Option::is_none")]
    pub object_uuid: Option<uuid::Uuid>,
    #[serde(rename = "object_type", skip_serializing_if = "Option::is_none")]
    pub object_type: Option<models::AnalystObjectType>,
    #[serde(rename = "authors", skip_serializing_if = "Option::is_none")]
    pub authors: Option<String>,
    #[serde(rename = "org_uuid", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "related_object_uuid", skip_serializing_if = "Option::is_none")]
    pub related_object_uuid: Option<uuid::Uuid>,
    #[serde(rename = "related_object_type", skip_serializing_if = "Option::is_none")]
    pub related_object_type: Option<models::AnalystObjectType>,
    #[serde(rename = "relationship_type", skip_serializing_if = "Option::is_none")]
    pub relationship_type: Option<String>,
    #[serde(rename = "note_type_name", skip_serializing_if = "Option::is_none")]
...
pub enum NoteTypeName {
    #[serde(rename = "Relationship")]
    Relationship,
}

impl Default for NoteTypeName {
    fn default() -> NoteTypeName {
        Self::Relationship
    }
}
