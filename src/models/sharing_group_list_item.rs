...
pub struct SharingGroupListItem {
    #[serde(rename = "SharingGroup", skip_serializing_if = "Option::is_none")]
    pub sharing_group: Option<Box<models::SlimSharingGroup>>,
    #[serde(rename = "Organisation", skip_serializing_if = "Option::is_none")]
    pub organisation: Option<Box<models::SharingGroupOrganisationOrganisation>>,
    #[serde(rename = "SharingGroupOrg", skip_serializing_if = "Option::is_none")]
    pub sharing_group_org: Option<Vec<models::SharingGroupOrganisation>>,
    #[serde(rename = "SharingGroupServer", skip_serializing_if = "Option::is_none")]
    pub sharing_group_server: Option<Vec<models::SharingGroupServer>>,
...
impl SharingGroupListItem {
    pub fn new() -> SharingGroupListItem {
