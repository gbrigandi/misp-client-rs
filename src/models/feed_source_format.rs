...
impl std::fmt::Display for FeedSourceFormat {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Variant1 => write!(f, "1"),
            Self::Csv => write!(f, "csv"),
            Self::Freetext => write!(f, "freetext"),
            Self::Misp => write!(f, "misp"),
        }
    }
}

impl Default for FeedSourceFormat {
    fn default() -> FeedSourceFormat {
        Self::Variant1
    }
}
