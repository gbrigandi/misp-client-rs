...
pub struct GetGalaxyClusterById200Response {
    #[serde(rename = "GalaxyCluster", skip_serializing_if = "Option::is_none")]
    pub galaxy_cluster: Option<Box<models::ExtendedGalaxyCluster>>,
}

impl GetGalaxyClusterById200Response {
    pub fn new() -> GetGalaxyClusterById200Response {
