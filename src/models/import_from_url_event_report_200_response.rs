...
pub struct ImportFromUrlEventReport200Response {
    /// `true` if the event report was succesfully created, `false` if it failed
...
impl ImportFromUrlEventReport200Response {
    pub fn new() -> ImportFromUrlEventReport200Response {
