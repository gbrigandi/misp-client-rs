...
pub struct ExportGalaxyClustersRequestGalaxy {
    /// `true` to filter out galaxy clusters with `default=true` set.
    #[serde(rename = "default", skip_serializing_if = "Option::is_none")]
    pub default: Option<bool>,
    /// `true` to filter out galaxy clusters with `default=false` set
    ...
    /// If set to `misp-galaxy` result set is in the misp-galaxy format.
    #[serde(rename = "format", skip_serializing_if = "Option::is_none")]
    pub format: Option<Format>,
    /// `true` returns the response as a json file attachment, `false` returns the response in the response body.
    #[serde(rename = "download", skip_serializing_if = "Option::is_none")]
    pub download: Option<bool>,
}

impl ExportGalaxyClustersRequestGalaxy {
    pub fn new() -> ExportGalaxyClustersRequestGalaxy {
