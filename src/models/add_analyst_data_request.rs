...
#[serde(untagged)]
pub enum AddAnalystDataRequest {
    AnalystNote(Box<models::AnalystNote>),
    AnalystOpinion(Box<models::AnalystOpinion>),
    AnalystRelationship(Box<models::AnalystRelationship>),
}

impl Default for AddAnalystDataRequest {
    fn default() -> Self {
        Self::AnalystNote(Default::default())
    }
}
/// 
