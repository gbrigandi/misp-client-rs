...
pub struct GetServerSettings200ResponseVersion {
...
impl GetServerSettings200ResponseVersion {
    pub fn new() -> GetServerSettings200ResponseVersion {
        GetServerSettings200ResponseVersion {
            current: None,
            newest: None,
            up_to_date: None,
        }
