...
pub struct GetAuthKeys200ResponseInner {
    #[serde(rename = "AuthKey", skip_serializing_if = "Option::is_none")]
    pub auth_key: Option<Box<models::AuthKey>>,
    #[serde(rename = "User", skip_serializing_if = "Option::is_none")]
    pub user: Option<Box<models::GetAuthKeys200ResponseInnerUser>>,
}

impl GetAuthKeys200ResponseInner {
    pub fn new() -> GetAuthKeys200ResponseInner {
        GetAuthKeys200ResponseInner {
            auth_key: None,
            user: None,
        }
    }
