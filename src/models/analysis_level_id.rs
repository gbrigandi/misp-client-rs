...
/// AnalysisLevelId : Represents the analysis maturity level.   * `0` - Initial   * `1` - Ongoing   * `2` - Complete 
/// Represents the analysis maturity level.   * `0` - Initial   * `1` - Ongoing   * `2` - Complete 
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum AnalysisLevelId {
    #[serde(rename = "0")]
    Variant0,
    #[serde(rename = "1")]
    Variant1,
...
impl std::fmt::Display for AnalysisLevelId {
...
impl Default for AnalysisLevelId {
    fn default() -> AnalysisLevelId {
        Self::Variant0
    }
}
