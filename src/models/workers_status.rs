...
pub struct WorkersStatus {
    ...
    pub workers: Option<Vec<models::Worker>>,
    #[serde(rename = "jobCount", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub job_count: Option<Option<i32>>,
}

impl WorkersStatus {
    pub fn new() -> WorkersStatus {
        WorkersStatus {
            ok: None,
            workers: None,
            job_count: None,
