...
pub struct GetWarninglists200ResponseWarninglistsInner {
    #[serde(rename = "Warninglist", skip_serializing_if = "Option::is_none")]
    pub warninglist: Option<Box<models::Warninglist>>,
}

impl GetWarninglists200ResponseWarninglistsInner {
    pub fn new() -> GetWarninglists200ResponseWarninglistsInner {
        GetWarninglists200ResponseWarninglistsInner {
            warninglist: None,
        }
    }
}
