...
/// DirectionSearchField : Sort direction of the result
/// Sort direction of the result
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum DirectionSearchField {
    #[serde(rename = "asc")]
    Asc,
    #[serde(rename = "desc")]
    Desc,
...
impl std::fmt::Display for DirectionSearchField {
...
impl Default for DirectionSearchField {
    fn default() -> DirectionSearchField {
        Self::Asc
    }
}
