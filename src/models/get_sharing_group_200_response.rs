...
pub struct GetSharingGroup200Response {
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Vec<models::SharingGroupListItem>>,
}

impl GetSharingGroup200Response {
    pub fn new() -> GetSharingGroup200Response {
        GetSharingGroup200Response {
            response: None,
        }
    }
}
