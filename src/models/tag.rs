...
pub struct Tag {
    ...
    #[serde(rename = "hide_tag", skip_serializing_if = "Option::is_none")]
    pub hide_tag: Option<bool>,
    #[serde(rename = "numerical_value", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub numerical_value: Option<Option<String>>,
    #[serde(rename = "is_galaxy", skip_serializing_if = "Option::is_none")]
    pub is_galaxy: Option<bool>,
    #[serde(rename = "is_custom_galaxy", skip_serializing_if = "Option::is_none")]
...
impl Tag {
    /// A tag is a simple method to classify an event with a simple string. The tag name can be freely chosen. The tag name can be also chosen from a fixed machine-tag vocabulary called MISP taxonomies
    pub fn new() -> Tag {
        Tag {
            name: None,
            colour: None,
