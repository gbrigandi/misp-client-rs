...
pub struct EventRestSearchListInner {
    #[serde(rename = "Event", skip_serializing_if = "Option::is_none")]
    pub event: Option<Box<models::EventRestSearchListInnerEvent>>,
}

impl EventRestSearchListInner {
    pub fn new() -> EventRestSearchListInner {
        EventRestSearchListInner {
            event: None,
        }
    }
}
