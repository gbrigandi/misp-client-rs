...
pub struct AttachGalaxyClusterAttachTargetIdParameter {
}

impl AttachGalaxyClusterAttachTargetIdParameter {
    pub fn new() -> AttachGalaxyClusterAttachTargetIdParameter {
