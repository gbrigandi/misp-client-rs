...
pub struct GetTaxonomies200ResponseInner {
    ...
    #[serde(rename = "current_count", skip_serializing_if = "Option::is_none")]
    pub current_count: Option<i32>,
}

impl GetTaxonomies200ResponseInner {
    pub fn new() -> GetTaxonomies200ResponseInner {
        GetTaxonomies200ResponseInner {
            taxonomy: None,
            total_count: None,
            current_count: None,
        }
