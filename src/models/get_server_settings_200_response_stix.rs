...
pub struct GetServerSettings200ResponseStix {
    #[serde(rename = "operational", skip_serializing_if = "Option::is_none")]
    pub operational: Option<i32>,
    #[serde(rename = "stix", skip_serializing_if = "Option::is_none")]
    pub stix: Option<Box<models::ServerPackageVersion>>,
    #[serde(rename = "cybox", skip_serializing_if = "Option::is_none")]
    pub cybox: Option<Box<models::ServerPackageVersion>>,
    #[serde(rename = "mixbox", skip_serializing_if = "Option::is_none")]
    pub mixbox: Option<Box<models::ServerPackageVersion>>,
    #[serde(rename = "maec", skip_serializing_if = "Option::is_none")]
    pub maec: Option<Box<models::ServerPackageVersion>>,
    #[serde(rename = "stix2", skip_serializing_if = "Option::is_none")]
    pub stix2: Option<Box<models::ServerPackageVersion>>,
    #[serde(rename = "pymisp", skip_serializing_if = "Option::is_none")]
    pub pymisp: Option<Box<models::ServerPackageVersion>>,
}

impl GetServerSettings200ResponseStix {
    pub fn new() -> GetServerSettings200ResponseStix {
        GetServerSettings200ResponseStix {
            operational: None,
            stix: None,
            cybox: None,
            mixbox: None,
