...
pub struct DecayingModelParameters {
    ...
    #[serde(rename = "decay_speed", skip_serializing_if = "Option::is_none")]
    pub decay_speed: Option<f32>,
    #[serde(rename = "threshold", skip_serializing_if = "Option::is_none")]
    pub threshold: Option<f32>,
    #[serde(rename = "default_base_score", skip_serializing_if = "Option::is_none")]
    pub default_base_score: Option<f32>,
    #[serde(rename = "base_score_config", skip_serializing_if = "Option::is_none")]
    pub base_score_config: Option<serde_json::Value>,
}
