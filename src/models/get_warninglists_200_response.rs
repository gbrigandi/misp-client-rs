...
pub struct GetWarninglists200Response {
    #[serde(rename = "Warninglists", skip_serializing_if = "Option::is_none")]
    pub warninglists: Option<Vec<models::GetWarninglists200ResponseWarninglistsInner>>,
}

impl GetWarninglists200Response {
    pub fn new() -> GetWarninglists200Response {
        GetWarninglists200Response {
            warninglists: None,
        }
    }
}
