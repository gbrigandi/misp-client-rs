...
pub struct IndexMinimalAnalystDataRequest {
    #[serde(rename = "orgc_name", skip_serializing_if = "Option::is_none")]
    pub orgc_name: Option<Box<models::IndexMinimalAnalystDataRequestOrgcName>>,
}

impl IndexMinimalAnalystDataRequest {
    pub fn new() -> IndexMinimalAnalystDataRequest {
        IndexMinimalAnalystDataRequest {
            orgc_name: None,
        }
    }
}
