...
pub struct DeleteGalaxy200Response {
    /// Present and `true` if the galaxy was succesfully removed.
...
impl DeleteGalaxy200Response {
    pub fn new() -> DeleteGalaxy200Response {
