...
pub struct EditServerSettingRequest {
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::EditServerSettingRequestValue>>,
}

impl EditServerSettingRequest {
    pub fn new() -> EditServerSettingRequest {
