...
pub struct GetServerSettings200ResponsePhpSettings {
    #[serde(rename = "max_execution_time", skip_serializing_if = "Option::is_none")]
    pub max_execution_time: Option<Box<models::PhpServerSetting>>,
    #[serde(rename = "memory_limit", skip_serializing_if = "Option::is_none")]
    pub memory_limit: Option<Box<models::PhpServerSetting>>,
    #[serde(rename = "upload_max_filesize", skip_serializing_if = "Option::is_none")]
    pub upload_max_filesize: Option<Box<models::PhpServerSetting>>,
    #[serde(rename = "post_max_size", skip_serializing_if = "Option::is_none")]
    pub post_max_size: Option<Box<models::PhpServerSetting>>,
}

impl GetServerSettings200ResponsePhpSettings {
    pub fn new() -> GetServerSettings200ResponsePhpSettings {
        GetServerSettings200ResponsePhpSettings {
