...
/// AttributesRestSearchReturnFormat : Format of the response payload
/// Format of the response payload
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum AttributesRestSearchReturnFormat {
    #[serde(rename = "json")]
    Json,
    #[serde(rename = "xml")]
    Xml,
...
impl std::fmt::Display for AttributesRestSearchReturnFormat {
...
impl Default for AttributesRestSearchReturnFormat {
    fn default() -> AttributesRestSearchReturnFormat {
        Self::Json
    }
}
