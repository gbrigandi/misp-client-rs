...
pub struct ExtendedGalaxyCluster {
    ...
    pub galaxy: Option<Box<models::Galaxy>>,
    #[serde(rename = "GalaxyClusterRelation", skip_serializing_if = "Option::is_none")]
    pub galaxy_cluster_relation: Option<Vec<models::GalaxyElement>>,
    #[serde(rename = "Org", skip_serializing_if = "Option::is_none")]
    pub org: Option<Box<models::Organisation>>,
    #[serde(rename = "Orgc", skip_serializing_if = "Option::is_none")]
    pub orgc: Option<Box<models::Organisation>>,
    #[serde(rename = "tag_count", skip_serializing_if = "Option::is_none")]
