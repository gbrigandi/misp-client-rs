...
pub struct RestSearchAttributes200ResponseResponse {
    #[serde(rename = "Attribute", skip_serializing_if = "Option::is_none")]
    pub attribute: Option<Vec<models::AttributeRestSearchListItem>>,
}

impl RestSearchAttributes200ResponseResponse {
    pub fn new() -> RestSearchAttributes200ResponseResponse {
        RestSearchAttributes200ResponseResponse {
            attribute: None,
        }
    }
}
