...
pub struct SearchUserSettingsRequest {
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(rename = "setting", skip_serializing_if = "Option::is_none")]
    pub setting: Option<models::UserSettingName>,
    #[serde(rename = "user_id", skip_serializing_if = "Option::is_none")]
    pub user_id: Option<String>,
}

impl SearchUserSettingsRequest {
    pub fn new() -> SearchUserSettingsRequest {
        SearchUserSettingsRequest {
            id: None,
            setting: None,
            user_id: None,
        }
