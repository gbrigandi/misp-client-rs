...
/// ObjectsRestSearchReturnFormat : Format of the response payload
/// Format of the response payload
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ObjectsRestSearchReturnFormat {
    #[serde(rename = "json")]
    Json,

}

impl std::fmt::Display for ObjectsRestSearchReturnFormat {
...
impl Default for ObjectsRestSearchReturnFormat {
    fn default() -> ObjectsRestSearchReturnFormat {
        Self::Json
    }
}
