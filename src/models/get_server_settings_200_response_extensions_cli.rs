...
pub struct GetServerSettings200ResponseExtensionsCli {
    #[serde(rename = "phpversion", skip_serializing_if = "Option::is_none")]
    pub phpversion: Option<String>,
}

impl GetServerSettings200ResponseExtensionsCli {
    pub fn new() -> GetServerSettings200ResponseExtensionsCli {
