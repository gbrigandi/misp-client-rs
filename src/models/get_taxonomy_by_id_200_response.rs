...
pub struct GetTaxonomyById200Response {
    ...
    pub entries: Option<Vec<models::TaxonomyEntry>>,
}

impl GetTaxonomyById200Response {
    pub fn new() -> GetTaxonomyById200Response {
        GetTaxonomyById200Response {
            taxonomy: None,
            entries: None,
        }
    }
