...
pub struct Sighting {
    ...
    #[serde(rename = "date_sighting", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "attribute_uuid", skip_serializing_if = "Option::is_none")]
    pub attribute_uuid: Option<uuid::Uuid>,
    #[serde(rename = "Organisation", skip_serializing_if = "Option::is_none")]
    pub organisation: Option<Box<models::SightingOrganisation>>,
}
