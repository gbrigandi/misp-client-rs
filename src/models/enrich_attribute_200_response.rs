...
pub struct EnrichAttribute200Response {
    /// Present and `true` if the attribute was succesfully enriched.
...
impl EnrichAttribute200Response {
    pub fn new() -> EnrichAttribute200Response {
        EnrichAttribute200Response {
            saved: None,
            success: None,
            name: None,
            message: None,
