...
#[serde(untagged)]
pub enum DecayScoreDecayingModel {
    DecayingModel(Box<models::DecayingModel>),
    FullDecayingModel(Box<models::FullDecayingModel>),
}

impl Default for DecayScoreDecayingModel {
    fn default() -> Self {
        Self::DecayingModel(Default::default())
    }
}
/// 
