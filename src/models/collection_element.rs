...
pub struct CollectionElement {
    ...
    #[serde(rename = "element_uuid", skip_serializing_if = "Option::is_none")]
    pub element_uuid: Option<uuid::Uuid>,
    #[serde(rename = "element_type", skip_serializing_if = "Option::is_none")]
