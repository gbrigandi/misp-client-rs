...
pub struct ImportGalaxyCluster200Response {
    /// Present and `true` if the galaxy was succesfully imported.
    #[serde(rename = "saved", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub saved: Option<Option<bool>>,
    /// Present and `true` if the galaxy was succesfully imported.
...
impl ImportGalaxyCluster200Response {
    pub fn new() -> ImportGalaxyCluster200Response {
        ImportGalaxyCluster200Response {
            saved: None,
            success: None,
            name: None,
            message: None,
