...
#[serde(untagged)]
pub enum EditAnalystDataAnalystDataIdParameter {
    AnalystDataId(String),
    Uuid(uuid::Uuid),
}

impl Default for EditAnalystDataAnalystDataIdParameter {
    fn default() -> Self {
        Self::AnalystDataId(Default::default())
    }
}
