...
pub struct GetServerSettings200ResponseExtensions {
    ...
    pub cli: Option<Box<models::GetServerSettings200ResponseExtensionsCli>>,
    #[serde(rename = "extensions", skip_serializing_if = "Option::is_none")]
    pub extensions: Option<serde_json::Value>,
}

impl GetServerSettings200ResponseExtensions {
    pub fn new() -> GetServerSettings200ResponseExtensions {
        GetServerSettings200ResponseExtensions {
            cli: None,
            extensions: None,
        }
    }
