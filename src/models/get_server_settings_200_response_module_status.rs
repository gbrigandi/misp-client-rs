...
pub struct GetServerSettings200ResponseModuleStatus {
    #[serde(rename = "Enrichment", skip_serializing_if = "Option::is_none")]
    pub enrichment: Option<i32>,
    ...
    pub cortex: Option<i32>,
}

impl GetServerSettings200ResponseModuleStatus {
    pub fn new() -> GetServerSettings200ResponseModuleStatus {
        GetServerSettings200ResponseModuleStatus {
            enrichment: None,
            import: None,
            export: None,
            cortex: None,
