...
pub struct AttachGalaxyCluster200Response {
    /// Present and `true` if the galaxy cluster was succesfully attached.
    #[serde(rename = "saved", skip_serializing_if = "Option::is_none")]
    pub saved: Option<bool>,
    /// Status message of the operation.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<String>,
    #[serde(rename = "check_publish", skip_serializing_if = "Option::is_none")]
    pub check_publish: Option<bool>,
}

impl AttachGalaxyCluster200Response {
    pub fn new() -> AttachGalaxyCluster200Response {
        AttachGalaxyCluster200Response {
            saved: None,
            success: None,
            check_publish: None,
        }
