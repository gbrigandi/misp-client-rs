...
#[serde(untagged)]
pub enum ExportGalaxyClusters200Response {
    Array(Vec<models::GalaxyCluster>),
    GalaxyMispFormat(Box<models::GalaxyMispFormat>),
}

impl Default for ExportGalaxyClusters200Response {
    fn default() -> Self {
