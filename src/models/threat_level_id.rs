...
/// ThreatLevelId : Represents the threat level.   * `1` - High   * `2` - Medium   * `3` - Low   * `4` - Undefined 
/// Represents the threat level.   * `1` - High   * `2` - Medium   * `3` - Low   * `4` - Undefined 
...
impl Default for ThreatLevelId {
    fn default() -> ThreatLevelId {
        Self::Variant1
    }
}
