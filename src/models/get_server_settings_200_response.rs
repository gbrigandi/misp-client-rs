...
pub struct GetServerSettings200Response {
    #[serde(rename = "version", skip_serializing_if = "Option::is_none")]
    pub version: Option<Box<models::GetServerSettings200ResponseVersion>>,
    #[serde(rename = "phpSettings", skip_serializing_if = "Option::is_none")]
    pub php_settings: Option<Box<models::GetServerSettings200ResponsePhpSettings>>,
    #[serde(rename = "gpgStatus", skip_serializing_if = "Option::is_none")]
    pub gpg_status: Option<String>,
    #[serde(rename = "proxyStatus", skip_serializing_if = "Option::is_none")]
    pub proxy_status: Option<String>,
    #[serde(rename = "zmqStatus", skip_serializing_if = "Option::is_none")]
    pub zmq_status: Option<i32>,
    #[serde(rename = "stix", skip_serializing_if = "Option::is_none")]
    pub stix: Option<Box<models::GetServerSettings200ResponseStix>>,
    #[serde(rename = "moduleStatus", skip_serializing_if = "Option::is_none")]
    pub module_status: Option<Box<models::GetServerSettings200ResponseModuleStatus>>,
    #[serde(rename = "writeableDirs", skip_serializing_if = "Option::is_none")]
    pub writeable_dirs: Option<serde_json::Value>,
    #[serde(rename = "writeableFiles", skip_serializing_if = "Option::is_none")]
    pub writeable_files: Option<serde_json::Value>,
    #[serde(rename = "readableFiles", skip_serializing_if = "Option::is_none")]
    pub readable_files: Option<serde_json::Value>,
    #[serde(rename = "dbDiagnostics", skip_serializing_if = "Option::is_none")]
    pub db_diagnostics: Option<serde_json::Value>,
    #[serde(rename = "dbSchemaDiagnostics", skip_serializing_if = "Option::is_none")]
    pub db_schema_diagnostics: Option<Box<models::GetServerSettings200ResponseDbSchemaDiagnostics>>,
    #[serde(rename = "redisInfo", skip_serializing_if = "Option::is_none")]
    pub redis_info: Option<serde_json::Value>,
    #[serde(rename = "finalSettings", skip_serializing_if = "Option::is_none")]
    pub final_settings: Option<Vec<models::MispSetting>>,
    #[serde(rename = "extensions", skip_serializing_if = "Option::is_none")]
    pub extensions: Option<Box<models::GetServerSettings200ResponseExtensions>>,
    #[serde(rename = "workers", skip_serializing_if = "Option::is_none")]
    pub workers: Option<Box<models::GetServerSettings200ResponseWorkers>>,
}
...
impl GetServerSettings200Response {
    pub fn new() -> GetServerSettings200Response {
        GetServerSettings200Response {
            ...
            module_status: None,
            writeable_dirs: None,
            writeable_files: None,
            readable_files: None,
            db_diagnostics: None,
            db_schema_diagnostics: None,
            redis_info: None,
            final_settings: None,
            extensions: None,
            workers: None,
