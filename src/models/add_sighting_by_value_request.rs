...
pub struct AddSightingByValueRequest {
    ...
    pub filters: Option<Box<models::AttributeRestSearchFilter>>,
}

impl AddSightingByValueRequest {
    pub fn new() -> AddSightingByValueRequest {
        AddSightingByValueRequest {
            values: None,
            timestamp: None,
            filters: None,
        }
