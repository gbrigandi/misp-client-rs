...
pub struct GetTaxonomyTags200Response {
    ...
    pub entries: Option<Vec<models::ExtendedTaxonomyEntry>>,
}

impl GetTaxonomyTags200Response {
    pub fn new() -> GetTaxonomyTags200Response {
        GetTaxonomyTags200Response {
            taxonomy: None,
            entries: None,
        }
    }
