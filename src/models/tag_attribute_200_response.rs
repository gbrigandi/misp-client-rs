...
pub struct TagAttribute200Response {
    /// `true` if the tag was succesfully added, `false` if it failed
...
impl TagAttribute200Response {
    pub fn new() -> TagAttribute200Response {
