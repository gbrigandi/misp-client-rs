...
pub struct GetCollectionsRequest {
    ...
    pub collection_period_uuid: Option<String>,
    #[serde(rename = "Collection.type", skip_serializing_if = "Option::is_none")]
    pub collection_period_type: Option<String>,
    #[serde(rename = "Collection.name", skip_serializing_if = "Option::is_none")]
    pub collection_period_name: Option<String>,
}

impl GetCollectionsRequest {
    pub fn new() -> GetCollectionsRequest {
        GetCollectionsRequest {
            collection_period_uuid: None,
            collection_period_type: None,
            collection_period_name: None,
        }
    }
}
