...
pub struct GetAuthKeyById200Response {
    #[serde(rename = "AuthKey", skip_serializing_if = "Option::is_none")]
    pub auth_key: Option<Box<models::AuthKey>>,
    #[serde(rename = "User", skip_serializing_if = "Option::is_none")]
    pub user: Option<Box<models::GetAuthKeyById200ResponseUser>>,
}

impl GetAuthKeyById200Response {
    pub fn new() -> GetAuthKeyById200Response {
        GetAuthKeyById200Response {
            auth_key: None,
            user: None,
        }
    }
