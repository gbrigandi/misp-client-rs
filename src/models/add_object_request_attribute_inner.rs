...
pub struct AddObjectRequestAttributeInner {
    ...
    #[serde(rename = "object_relation", skip_serializing_if = "Option::is_none")]
    pub object_relation: Option<String>,
}

impl AddObjectRequestAttributeInner {
    pub fn new() -> AddObjectRequestAttributeInner {
        AddObjectRequestAttributeInner {
            category: None,
            value: None,
            to_ids: None,
