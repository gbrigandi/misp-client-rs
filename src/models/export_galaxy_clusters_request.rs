...
pub struct ExportGalaxyClustersRequest {
    #[serde(rename = "Galaxy", skip_serializing_if = "Option::is_none")]
    pub galaxy: Option<Box<models::ExportGalaxyClustersRequestGalaxy>>,
}

impl ExportGalaxyClustersRequest {
    pub fn new() -> ExportGalaxyClustersRequest {
        ExportGalaxyClustersRequest {
            galaxy: None,
        }
    }
}
